...
samples = add_to_samples('CarND-Behavioral-Cloning-P3/data/driving_log.csv', samples)
    ...
    while 1: # Loop forever so the generator never terminates
        ...
        for offset in range(0, num_samples, batch_size):
            ...
            for batch_sample in batch_samples:
                name = 'CarND-Behavioral-Cloning-P3/data/'+batch_sample[0]
...
def resize_comma(image):
    ...
    image_size = (40,160)
    return tf.image.resize_images(image, (image_size[0], image_size[1]))
...
checkpointer = ModelCheckpoint(filepath="CarND-Behavioral-Cloning-P3/tmp/v2-weights.{epoch:02d}-{val_loss:.2f}.hdf5", verbose=1, save_best_only=False)
...
with open("CarND-Behavioral-Cloning-P3/model.json", "w") as json_file:
    json_file.write(model_json)
    
model.save_weights("CarND-Behavioral-Cloning-P3/model_weights.h5")
